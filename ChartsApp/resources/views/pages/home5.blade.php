...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <form action="{{ route('search4', ['id' => $category->is1_id])}}" method="POST" role="search" autocomplete="off">
                            {{ csrf_field() }}
                            <div class="row">
     ...
     @include('includes.alerts.errors')
                <h2 style="text-align:center"><a href="{{ url('home3')}}/">{{ $category->is1_name1 }} </a></h2>
                 <div class="card-body">
                           ...
                           <tr class="color-white" style="background-color:#16A98C;">
                            ...
                            @foreach ($query as $key =>  $item)
                                <tr>
                                       ...
                                       <td  scope="row" style="fixed: true">{{$item->PsBranch}}</td>
                                       <td scope="row" style="background-color:#FFAD5B">{{number_format((float)$item->PsBranchCodeSales, 2)}}</td>
                            ...
                            <tr style="background-color: #C93D2E; color: white;">
                                 <td scope="row">10</td>
                                <td scope="row">   اجمالى مبيعات الفروع للقسم</td>
                                 <td scope="row">{{number_format((float) $total_branch[0]->PsIs1Sales, 2) }}</td>
                                </tr>
